  ...
  return (
    <React.Fragment>
      <div
        ...
        className="card_animation transition-colors cursor-pointer border-[.125rem] max-w-[16.9375rem] h-auto border-dashed border-[#332154] bg-[#4990E833] hover:bg-[#4990E836] hover:transition-colors rounded-[1.25rem]"
      >

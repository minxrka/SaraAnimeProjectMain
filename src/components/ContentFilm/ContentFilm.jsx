    ...
    <div className="max-w-[1500px] mx-auto">
      ...
      <main className="overflow-hidden px-[20px] py-[20px] border-solid border border-mainLightRed rounded-[20px]">
        ...
        <div className="flex justify-center mt-[100px] mb-[100px]">
          <button className="py-[18px] px-[21px] border-solid border border-cyberpunk rounded-[30px] font-GothamPro text-white font-light hover:bg-superLightRed transition-colors">
            Смотреть ещё
          </button>
        </div>
      </main>

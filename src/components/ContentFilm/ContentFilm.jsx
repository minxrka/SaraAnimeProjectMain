...
import Anime9 from "../../img/bg-anime-card/small/5a709a018f697.jpg";
import Anime10 from "../../img/bg-anime-card/small/5a743e804fcb8.jpg";
import Anime11 from "../../img/bg-anime-card/small/5ad264d801ac6117576552.jpg";
import Anime12 from "../../img/bg-anime-card/small/5bd44a78177e0386016094.jpg";
import Anime13 from "../../img/bg-anime-card/small/c6cdd36ef0e3ca592e08e062436e3d2d.jpg";
import Anime14 from "../../img/bg-anime-card/small/771ca8db3c228edd2098b1dce2e21e6f.jpg";
import Anime15 from "../../img/bg-anime-card/small/6492bccecad5a252978706.jpg";
import Anime16 from "../../img/bg-anime-card/small/Mob Psycho 100.jpg";
import Anime17 from "../../img/bg-anime-card/small/Yakusoku no Neverland.jpg";
import Anime18 from "../../img/bg-anime-card/small/615892a466731826216940.jpg";
import Anime19 from "../../img/bg-anime-card/small/64a9dff36c36f728344913.jpg";
import Anime20 from "../../img/bg-anime-card/small/5c2caac1ba56e349750816.jpg";
import Anime21 from "../../img/bg-anime-card/small/63a6167d44f0f812933114.jpg";
import Anime22 from "../../img/bg-anime-card/small/60a7c077d1b10176373317.jpg";
import Anime23 from "../../img/bg-anime-card/small/60ab941799f50715650987.jpg";
import Anime24 from "../../img/bg-anime-card/small/61c0e7650a79e589259475.jpg";
import Anime25 from "../../img/bg-anime-card/small/5a47ae2e45700.jpg";
import Anime26 from "../../img/bg-anime-card/small/5a7b5d45a7780671439287.jpg";
import Anime27 from "../../img/bg-anime-card/small/5f422c74517b8366786351.jpg";
import Anime28 from "../../img/bg-anime-card/small/5fa133e876982290741352.jpg";
  ...
  return (
    <div className="max-w-[1500px] mx-auto">
      ...
      <main className="overflow-hidden px-[20px] py-[20px] border-solid border border-mainBlue rounded-[20px]">
        <section className="flex justify-between flex-wrap gap-[80px] lg:gap-[40px] md:justify-center">
          {/* ///////////////////////// */}
          <div className="spanhovereffect bgZoomEffect w-[250px] sm:w-full">
            <NavLink to={`/watch/`}>
              ...
              <div className="flex flex-col justify-between">
                <h1 className="text-center font-GothamPro text-white text-[18px] font-light mt-[8px] textwrap lineclampone">
          ...
          <div className="spanhovereffect bgZoomEffect w-[250px] sm:w-full">
            <NavLink to={`/watch/`}>
              <div className="bgZoomEffect overflow-hidden relative rounded-[20px] objFit">
                <img className="rounded-[20px] hui" src={Anime9} alt="" />
                <div className="spanbgeffect anime absolute top-0 bg-black spanbgeffect rounded-[20px] w-full h-full opacity-0 transition-all">
                  <span className="">
                    <svg
                      className="max-w-[110px] h-full mx-auto svgPlay"
              ...
              <div className="flex flex-col justify-between">
                ...
                <p className="text-[15px] text-center font-GothamPro font-light text-gray-200 mt-[8px] textwrap lineclampone">
                  2011,Adventure, Senen, Super Power, Fantasy, Actions
                </p>
              </div>
            </NavLink>
          </div>
          ...
          <div className="spanhovereffect bgZoomEffect w-[250px] sm:w-full">
            <NavLink to={`/watch/`}>
              <div className="bgZoomEffect overflow-hidden relative rounded-[20px] objFit">
                <img className="rounded-[20px] hui" src={Anime10} alt="" />
                <div className="spanbgeffect anime absolute top-0 bg-black spanbgeffect rounded-[20px] w-full h-full opacity-0 transition-all">
                  <span className="">
                    <svg
                      className="max-w-[110px] h-full mx-auto svgPlay"
              ...
              <div className="flex flex-col justify-between">
                ...
                <p className="text-[15px] text-center font-GothamPro font-light text-gray-200 mt-[8px] textwrap lineclampone">
                  2008, Military, Drama, Mecha, Super Power, Scien...
                </p>
              </div>
            </NavLink>
          </div>
          ...
          <div className="spanhovereffect bgZoomEffect w-[250px] sm:w-full">
            <NavLink to={`/watch/`}>
              <div className="bgZoomEffect overflow-hidden relative rounded-[20px] objFit">
                <img className="rounded-[20px] hui" src={Anime11} alt="" />
                <div className="spanbgeffect anime absolute top-0 bg-black spanbgeffect rounded-[20px] w-full h-full opacity-0 transition-all">
                  <span className="">
                    <svg
                      className="max-w-[110px] h-full mx-auto svgPlay"
              ...
              <div className="flex flex-col justify-between">
                ...
                <p className="text-[15px] text-center font-GothamPro font-light text-gray-200 mt-[8px] textwrap lineclampone">
                  1999, Drama, Comedy, Everyday Life, Senen, School
                </p>
              </div>
            </NavLink>
          </div>
          ...
          <div className="spanhovereffect bgZoomEffect w-[250px] sm:w-full">
            <NavLink to={`/watch/`}>
              <div className="bgZoomEffect overflow-hidden relative rounded-[20px] objFit">
                <img className="rounded-[20px] hui" src={Anime12} alt="" />
                <div className="spanbgeffect anime absolute top-0 bg-black spanbgeffect rounded-[20px] w-full h-full opacity-0 transition-all">
                  <span className="">
                    <svg
                      className="max-w-[110px] h-full mx-auto svgPlay"
              ...
              <div className="flex flex-col justify-between">
                ...
                <p className="text-[15px] text-center font-GothamPro font-light text-gray-200 mt-[8px] textwrap lineclampone">
                  2018,Comedy, Romance, Supernatural, School
                </p>
              </div>
            </NavLink>
          </div>
          ...
          <div className="spanhovereffect bgZoomEffect w-[250px] sm:w-full">
            <NavLink to={`/watch/`}>
              <div className="bgZoomEffect overflow-hidden relative rounded-[20px] objFit">
                <img className="rounded-[20px] hui" src={Anime13} alt="" />
                <div className="spanbgeffect anime absolute top-0 bg-black spanbgeffect rounded-[20px] w-full h-full opacity-0 transition-all">
                  <span className="">
                    <svg
                      className="max-w-[110px] h-full mx-auto svgPlay"
          ...
          <div className="spanhovereffect bgZoomEffect w-[250px] sm:w-full">
            <NavLink to={`/watch/`}>
              <div className="bgZoomEffect overflow-hidden relative rounded-[20px] objFit">
                <img className="rounded-[20px] hui" src={Anime14} alt="" />
                <div className="spanbgeffect anime absolute top-0 bg-black spanbgeffect rounded-[20px] w-full h-full opacity-0 transition-all">
                  <span className="">
                    <svg
                      className="max-w-[110px] h-full mx-auto svgPlay"
              ...
              <div className="flex flex-col justify-between">
                ...
                <p className="text-[15px] text-center font-GothamPro font-light text-gray-200 mt-[8px] textwrap lineclampone">
                  1999, Drama, Comedy, Adventure, Senen, Super P...
                </p>
              </div>
            </NavLink>
          </div>
          ...
          <div className="spanhovereffect bgZoomEffect w-[250px] sm:w-full">
            <NavLink to={`/watch/`}>
              <div className="bgZoomEffect overflow-hidden relative rounded-[20px] objFit">
                <img className="rounded-[20px] hui" src={Anime15} alt="" />
                <div className="spanbgeffect anime absolute top-0 bg-black spanbgeffect rounded-[20px] w-full h-full opacity-0 transition-all">
                  <span className="">
                    <svg
                      className="max-w-[110px] h-full mx-auto svgPlay"
              ...
              <div className="flex flex-col justify-between">
                ...
                <p className="text-[15px] text-center font-GothamPro font-light text-gray-200 mt-[8px] textwrap lineclampone">
                  2023, Comedy, Supernatural, Seinen, Ho...
                </p>
              </div>
            </NavLink>
          </div>
          ...
          <div className="spanhovereffect bgZoomEffect w-[250px] sm:w-full">
            <NavLink to={`/watch/`}>
              <div className="bgZoomEffect overflow-hidden relative rounded-[20px] objFit">
                <img className="rounded-[20px] hui" src={Anime16} alt="" />
                <div className="spanbgeffect anime absolute top-0 bg-black spanbgeffect rounded-[20px] w-full h-full opacity-0 transition-all">
                  <span className="">
                    <svg
                      className="max-w-[110px] h-full mx-auto svgPlay"
          ...
          <div className="spanhovereffect bgZoomEffect w-[250px] sm:w-full">
            <NavLink to={`/watch/`}>
              <div className="bgZoomEffect overflow-hidden relative rounded-[20px] objFit">
                <img className="rounded-[20px] hui" src={Anime17} alt="" />
                <div className="spanbgeffect anime absolute top-0 bg-black spanbgeffect rounded-[20px] w-full h-full opacity-0 transition-all">
                  <span className="">
                    <svg
                      className="max-w-[110px] h-full mx-auto svgPlay"
          ...
          <div className="spanhovereffect bgZoomEffect w-[250px] sm:w-full">
            <NavLink to={`/watch/`}>
              <div className="bgZoomEffect overflow-hidden relative rounded-[20px] objFit">
                <img className="rounded-[20px] hui" src={Anime18} alt="" />
                <div className="spanbgeffect anime absolute top-0 bg-black spanbgeffect rounded-[20px] w-full h-full opacity-0 transition-all">
                  <span className="">
                    <svg
                      className="max-w-[110px] h-full mx-auto svgPlay"
              ...
              <div className="flex flex-col justify-between">
                ...
                <p className="text-[15px] text-center font-GothamPro font-light text-gray-200 mt-[8px] textwrap lineclampone">
                  2021, Drama, Science Fiction, Action
                </p>
              </div>
            </NavLink>
          </div>
          ...
          <div className="spanhovereffect bgZoomEffect w-[250px] sm:w-full">
            <NavLink to={`/watch/`}>
              <div className="bgZoomEffect overflow-hidden relative rounded-[20px] objFit">
                <img className="rounded-[20px] hui" src={Anime19} alt="" />
                <div className="spanbgeffect anime absolute top-0 bg-black spanbgeffect rounded-[20px] w-full h-full opacity-0 transition-all">
                  <span className="">
                    <svg
                      className="max-w-[110px] h-full mx-auto svgPlay"
              ...
              <div className="flex flex-col justify-between">
                ...
                <p className="text-[15px] text-center font-GothamPro font-light text-gray-200 mt-[8px] textwrap lineclampone">
                  2022, Detective, Drama, Science Fiction
                </p>
              </div>
            </NavLink>
          </div>
          ...
          <div className="spanhovereffect bgZoomEffect w-[250px] sm:w-full">
            <NavLink to={`/watch/`}>
              <div className="bgZoomEffect overflow-hidden relative rounded-[20px] objFit">
                <img className="rounded-[20px] hui" src={Anime20} alt="" />
                <div className="spanbgeffect anime absolute top-0 bg-black spanbgeffect rounded-[20px] w-full h-full opacity-0 transition-all">
                  <span className="">
                    <svg
                      className="max-w-[110px] h-full mx-auto svgPlay"
              ...
              <div className="flex flex-col justify-between">
                ...
                <p className="text-[15px] text-center font-GothamPro font-light text-gray-200 mt-[8px] textwrap lineclampone">
                  2022, Harem, Comedy, Romance, Senen, School
                </p>
              </div>
            </NavLink>
          </div>
          ...
          <div className="spanhovereffect bgZoomEffect w-[250px] sm:w-full">
            <NavLink to={`/watch/`}>
              <div className="bgZoomEffect overflow-hidden relative rounded-[20px] objFit">
                <img className="rounded-[20px] hui" src={Anime21} alt="" />
                <div className="spanbgeffect anime absolute top-0 bg-black spanbgeffect rounded-[20px] w-full h-full opacity-0 transition-all">
                  <span className="">
                    <svg
                      className="max-w-[110px] h-full mx-auto svgPlay"
              ...
              <div className="flex flex-col justify-between">
                ...
                <p className="text-[15px] text-center font-GothamPro font-light text-gray-200 mt-[8px] textwrap lineclampone">
                  2022, Drama, Supernatural, Action
                </p>
              </div>
            </NavLink>
          </div>
          ...
          <div className="spanhovereffect bgZoomEffect w-[250px] sm:w-full">
            <NavLink to={`/watch/`}>
              <div className="bgZoomEffect overflow-hidden relative rounded-[20px] objFit">
                <img className="rounded-[20px] hui" src={Anime22} alt="" />
                <div className="spanbgeffect anime absolute top-0 bg-black spanbgeffect rounded-[20px] w-full h-full opacity-0 transition-all">
                  <span className="">
                    <svg
                      className="max-w-[110px] h-full mx-auto svgPlay"
          ...
          <div className="spanhovereffect bgZoomEffect w-[250px] sm:w-full">
            <NavLink to={`/watch/`}>
              <div className="bgZoomEffect overflow-hidden relative rounded-[20px] objFit">
                <img className="rounded-[20px] hui" src={Anime23} alt="" />
                <div className="spanbgeffect anime absolute top-0 bg-black spanbgeffect rounded-[20px] w-full h-full opacity-0 transition-all">
                  <span className="">
                    <svg
                      className="max-w-[110px] h-full mx-auto svgPlay"
              ...
              <div className="flex flex-col justify-between">
                <h1 className="text-center font-GothamPro text-white text-[18px] font-light mt-[8px] textwrap lineclampone">
                  Корзинка фруктов: Финал
                </h1>
                <p className="text-[15px] text-center font-GothamPro font-light text-gray-200 mt-[8px] textwrap lineclampone">
                  2021, Drama, Comedy, Everyday, Romance, Super...
                </p>
              </div>
            </NavLink>
          </div>
          ...
          <div className="spanhovereffect bgZoomEffect w-[250px] sm:w-full">
            <NavLink to={`/watch/`}>
              <div className="bgZoomEffect overflow-hidden relative rounded-[20px] objFit">
                <img className="rounded-[20px] hui" src={Anime24} alt="" />
                <div className="spanbgeffect anime absolute top-0 bg-black spanbgeffect rounded-[20px] w-full h-full opacity-0 transition-all">
                  <span className="">
                    <svg
                      className="max-w-[110px] h-full mx-auto svgPlay"
              ...
              <div className="flex flex-col justify-between">
                ...
                <p className="text-[15px] text-center font-GothamPro font-light text-gray-200 mt-[8px] textwrap lineclampone">
                  2021, Demons, Historical, Supernatural, Senen, Fanta...
                </p>
              </div>
            </NavLink>
          </div>
          ...
          <div className="spanhovereffect bgZoomEffect w-[250px] sm:w-full">
            <NavLink to={`/watch/`}>
              <div className="bgZoomEffect overflow-hidden relative rounded-[20px] objFit">
                <img className="rounded-[20px] hui" src={Anime25} alt="" />
                <div className="spanbgeffect anime absolute top-0 bg-black spanbgeffect rounded-[20px] w-full h-full opacity-0 transition-all">
                  <span className="">
                    <svg
                      className="max-w-[110px] h-full mx-auto svgPlay"
              ...
              <div className="flex flex-col justify-between">
                ...
                <p className="text-[15px] text-center font-GothamPro font-light text-gray-200 mt-[8px] textwrap lineclampone">
                  2009, Military, Drama, Comedy, Magic, Adventure...
                </p>
              </div>
            </NavLink>
          </div>
          ...
          <div className="spanhovereffect bgZoomEffect w-[250px] sm:w-full">
            <NavLink to={`/watch/`}>
              <div className="bgZoomEffect overflow-hidden relative rounded-[20px] objFit">
                <img className="rounded-[20px] hui" src={Anime26} alt="" />
                <div className="spanbgeffect anime absolute top-0 bg-black spanbgeffect rounded-[20px] w-full h-full opacity-0 transition-all">
                  <span className="">
                    <svg
                      className="max-w-[110px] h-full mx-auto svgPlay"
              ...
              <div className="flex flex-col justify-between">
                ...
                <p className="text-[15px] text-center font-GothamPro font-light text-gray-200 mt-[8px] textwrap lineclampone">
                  2022, Adventure, Romance, Fantasy, Action
                </p>
              </div>
            </NavLink>
          </div>
          ...
          <div className="spanhovereffect bgZoomEffect w-[250px] sm:w-full">
            <NavLink to={`/watch/`}>
              <div className="bgZoomEffect overflow-hidden relative rounded-[20px] objFit">
                <img className="rounded-[20px] hui" src={Anime27} alt="" />
                <div className="spanbgeffect anime absolute top-0 bg-black spanbgeffect rounded-[20px] w-full h-full opacity-0 transition-all">
                  <span className="">
                    <svg
                      className="max-w-[110px] h-full mx-auto svgPlay"
              ...
              <div className="flex flex-col justify-between">
                <h1 className="text-center font-GothamPro text-white text-[18px] font-light mt-[8px] textwrap lineclampone">
                  Волейбол!! К вершине 2
                </h1>
                <p className="text-[15px] text-center font-GothamPro font-light text-gray-200 mt-[8px] textwrap lineclampone">
                  2020, Drama, Comedy, Senen, Sports, School
                </p>
              </div>
            </NavLink>
          </div>
          ...
          <div className="spanhovereffect bgZoomEffect w-[250px] sm:w-full">
            <NavLink to={`/watch/`}>
              <div className="bgZoomEffect overflow-hidden relative rounded-[20px] objFit">
                <img className="rounded-[20px] hui" src={Anime28} alt="" />
                <div className="spanbgeffect anime absolute top-0 bg-black spanbgeffect rounded-[20px] w-full h-full opacity-0 transition-all">
                  <span className="">
                    <svg
                      className="max-w-[110px] h-full mx-auto svgPlay"
              ...
              <div className="flex flex-col justify-between">
                ...
                <p className="text-[15px] text-center font-GothamPro font-light text-gray-200 mt-[8px] textwrap lineclampone">
                  2020, Drama, Historical, Adventure, Supernatural, A...
                </p>
              </div>
            </NavLink>
          </div>
        ...
        <div className="flex justify-center mt-[100px] mb-[100px]">
          <button className="py-[18px] px-[21px] border-solid border border-cyberpunk rounded-[30px] font-GothamPro text-white font-light buttonShowMore transition-colors">
            Смотреть ещё
          </button>
        </div>
      </main>

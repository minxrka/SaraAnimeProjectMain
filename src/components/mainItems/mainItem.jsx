...
import Anime2 from "../../img/bg-anime-card/small/My Hero Academia.jpg";
import Anime3 from "../../img/bg-anime-card/small/Oshi no Ko.jpg";
import Anime4 from "../../img/bg-anime-card/small/bleach.jpg";
import Anime5 from "../../img/bg-anime-card/small/Made in abyss.jpg";
